...
export const metadata: Metadata = {
  title: { absolute: 'PVC logi, žalūzijas un montāža Rīgā | Vestalux' },
  description:
                  ...
                  >
                    ...
                    <div className="mt-auto space-y-4 pt-6">
                      ...
                      {option.key === 'vertical' ? (
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                          <a href="/zaluzijas/aluminija" className={solidButtonClass}>
                            Precīza kontrole
                          </a>
                          <a href="/zaluzijas/koka" className={outlineButtonClass}>
                            Dabiska elegance
                          </a>
                        </div>
                      ) : option.key === 'rullo' ? (
