...
import KasetuDienaNaktsCalculator from '@/components/zaluzijas/KasetuDienaNaktsCalculator'
    ...
    <>
      <JsonLd
        data={breadcrumbSchema([
          { name: 'Sākums', path: '/' },
          { name: 'Žalūzijas', path: '/zaluzijas' },
          { name: product.title, path: `/zaluzijas/${id}` },
        ])}
      />
