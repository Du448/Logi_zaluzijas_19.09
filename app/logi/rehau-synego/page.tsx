        ...
        <div className="container py-12 md:py-16">
          ...
          <div className="grid md:grid-cols-[1fr_auto_1fr] gap-8 md:gap-10">
            ...
            <div className="space-y-5 text-gray-700">
              ...
              <Reveal className="flex gap-3 items-start p-3 rounded-lg border border-brand-blue/20 bg-brand-blue/10 hover:bg-brand-blue/15 hover:shadow-sm transition">
              ...
              <Reveal>
                <img
                  ...
                  alt="REHAU SYNEGO"
                  className="w-full max-h-[520px] object-contain bg-white rounded-xl shadow-md ring-1 ring-brand-blue/30 p-2"
                />
              </Reveal>
            </div>

            {/* Dividers */}
            <div className="hidden md:block w-px bg-gradient-to-b from-brand-blue/20 via-brand-blue/30 to-brand-blue/20" />
            <div className="md:hidden h-px bg-gradient-to-r from-brand-blue/20 via-brand-blue/30 to-brand-blue/20" />

            {/* Right column (sticky) */}
            <div className="space-y-5 text-gray-700 md:sticky md:top-24">
              <Reveal>
                <h2 className="text-2xl font-semibold text-gray-900">REHAU SYNEGO logi: klusums un drošība jūsu mājās</h2>
              </Reveal>

              <Reveal className="p-4 rounded-xl border border-brand-blue/20 bg-brand-blue/10 hover:bg-brand-blue/15 hover:shadow transition">
          ...
          <div className="mt-12 flex items-center gap-4">
            <a href="/kontakti" className="inline-block px-6 py-3 rounded-md bg-brand-blue text-white font-semibold hover:opacity-90 transition">Saņemt piedāvājumu</a>
            <a href="/logi" className="text-brand-blue hover:underline">Atpakaļ uz profilu sarakstu</a>
          </div>
        </div>
      </section>
