      ...
      <section className="bg-white">
        <div className="container py-14">
          <FAQ
            items={[
              {
                q: 'Cik ilgā laikā izgatavo PVC logus?',
                a: 'Atkarībā no konfigurācijas izgatavošana parasti aizņem 3–6 nedēļas. Aktīvajā sezonā termiņš var nedaudz mainīties - precīzu termiņu norādām piedāvājumā.',
              },
              {
                q: 'Kāda garantija tiek dota logiem un montāžai?',
                a: 'Logiem un montāžas darbiem nodrošinām 2 gadu garantiju saskaņā ar līgumu un ražotāja noteikumiem.',
              },
              {
                q: 'Vai logus var uzstādīt arī ziemā?',
                a: 'Jā, PVC logu montāža notiek visu gadu. Ziemā izmantojam atbilstošus montāžas materiālus un tehnoloģiju, lai telpas neatdzistu un šuves būtu kvalitatīvas.',
              },
              {
                q: 'Kas ir U-vērtība un kāpēc tā ir svarīga?',
                a: 'U-vērtība (Uw) raksturo loga siltumizolāciju - jo zemāka vērtība, jo siltāks logs. Mūsdienīgam logam Latvijas klimatā ieteicama Uw vērtība zem 1.0 W/(m²K); mūsu profili ar trīskāršo stiklojumu to nodrošina.',
              },
              {
                q: 'Vai veicat bezmaksas uzmērīšanu un konsultāciju?',
                a: 'Jā, piedāvājam bezmaksas konsultāciju un precīzu tāmi. Mērīšanas darbus veicam Rīgā un Pierīgā, piegādes iespējamas visā Latvijā.',
              },
            ]}
          />
        </div>
