    ...
    <div className="text-gray-900">
        ...
        <div className="relative container py-16 md:py-24">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="io-slide-right">
              ...
              <img src={ikUrl("https://ik.imagekit.io/vbvwdejj5/PAKALPOJUMU%20LAPA/Gluing_of_extended_protruding_window_profile.jpeg?updatedAt=1757082006698", { w: 1200 })} alt="Montāžas darbu ilustrācija" className="w-full rounded-2xl shadow-lg" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container py-14 md:py-16">
          <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <div className="io-slide-right">
              ...
              <img src={ikUrl("https://ik.imagekit.io/vbvwdejj5/fukasqf.png?updatedAt=1758215780968", { w: 1200 })} alt="Montāžas process" className="w-full rounded-2xl shadow" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="container py-10 io-fade-up">
          ...
          <img
            src={ikUrl("https://ik.imagekit.io/vbvwdejj5/apuqc3apuq%20-.png?updatedAt=1758216707831", { w: 1280 })}
