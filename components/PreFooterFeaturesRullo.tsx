...
export default function PreFooterFeaturesRullo() {
  return (
      ...
      <div className="max-w-[76.8rem] mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="group text-center p-6 rounded-xl border border-gray-200 bg-white transition hover:-translate-y-1 hover:shadow-lg hover:border-blue-200">
          ...
          <div className="text-black text-left max-w-xl mx-auto space-y-3">
            <div>
              <div className="font-semibold">1. Montāžas iespējas</div>
              <p>Vienalga, vai vēlaties tās uzstādīt uz loga stikla paketes, pie sienas vai griestiem, rullo žalūzijas lieliski iekļausies jebkurā interjerā. Šī daudzpusība sniedz jums brīvību radīt tieši tādu noskaņu, kādu esat iedomājies.</p>
            </div>
            <div>
              <div className="font-semibold">2. Krāsas un faktūras</div>
              <p>Pateicoties plašajam audumu klāstam, jūs varat eksperimentēt ar krāsām un faktūrām. No klasiskiem, neitrāliem toņiem līdz košām krāsām un interesantām tekstūrām – atradīsit sev piemērotāko variantu, kas piešķirs telpai raksturu.</p>
            </div>
            <div>
              <div className="font-semibold">3. Gaismas kontrole</div>
              <p>Ne tikai estētika, bet arī funkcionalitāte ir šo žalūziju priekšrocība. Jūs varat izvēlēties starp audumiem, kas maigi izkliedē saules gaismu, radot mājīgu atmosfēru, vai pilnībā bloķē gaismu, nodrošinot 100% aptumšojumu, kas ideāli piemērots guļamistabām vai konferenču zālēm.</p>
            </div>
            <div>
              <div className="font-semibold">4. Ilgmūžība un kopšana</div>
              <p>Rullo žalūzijas ir viegli kopjamas un ilgmūžīgas. Audumi ir izturīgi pret izbalēšanu, un, ja vēlaties atsvaidzināt interjeru vai mainīt stilu, audumu ir viegli nomainīt.</p>
            </div>
          </div>
        </div>
        <div className="group text-center p-6 rounded-xl border border-gray-200 bg-white transition hover:-translate-y-1 hover:shadow-lg hover:border-blue-200">
