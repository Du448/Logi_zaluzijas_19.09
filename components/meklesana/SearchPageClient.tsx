          ...
          <div className="flex-1">
            ...
            <div className="mt-3 flex items-center text-sm text-gray-500">
              <span className="truncate">
                {typeof window !== 'undefined' ? new URL(result.url, window.location.origin).pathname : result.url}
              </span>
              {result.date && <span className="mx-2">•</span>}
              {result.date && <span className="whitespace-nowrap">{result.date}</span>}
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Meklēšanas rezultāti</h1>
          ...
          <div className="space-y-4">
            {isLoading ? (
              ...
              <AnimatePresence>
                <div className="space-y-4">
                  <p className="text-sm text-gray-500">Atrasti {results.length} rezultāti</p>
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 max-w-md mx-auto">Izmantojiet meklēšanas lauku augšā, lai atrastu vajadzīgo informāciju mūsu vietnē.</p>
              </div>
            )}
          </div>
        </div>
