      ...
      <div className="container py-10">
        <div className="grid md:grid-cols-3 gap-6 items-center">
          ...
          <div className="flex gap-3 md:justify-end">
            <a href="https://wa.me/37120000000" className="inline-flex items-center justify-center rounded-md bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-3 font-semibold">WhatsApp</a>
